...
func TestSolidSquareDetection(t *testing.T) {
	...
	board[0][0].Answer = puz.SolidSquare
	board[0][1].Answer = puz.DiagramlessSolidSquare
...
func TestWordStartDetection(t *testing.T) {
	...
	board[2][2].Answer = puz.SolidSquare
	...
	board[2][1].Answer = puz.SolidSquare
	board[4][2].Answer = puz.SolidSquare
